...
urlpatterns = [
    ...
    path("logs/<str:id>",views.DoctorLogs.as_view(),name = "logs"),
    ...
    path("activate-deactivate-doctor/<str:id>", views.ActivateDeactivateDoctorView.as_view(), name="activate_deactivate"),
